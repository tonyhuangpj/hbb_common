...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "1qaz2wsx#EDC$RFV".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["zhixiangpc.com"];
pub const RS_PUB_KEY: &str = "oVachsK1fgXaO7aWHXqKn8cd2OOqLHBe+D0eqobXvJg=";
